                    ...
                    <tbody>
                        <tr
                            ...
                            <th scope="row"
                                ...
                                <img className="w-10 h-10 rounded-full" src="./profile.svg"
                                    alt="Jese image"/>
                                <div className="ps-3">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-violet-500 me-2"></div>super fast
                                </div>
                            </td>
                        ...
                        <tr
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div>prediction king
                                </div>
                            </td>
                        ...
                        <tr
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-orange-500 me-2"></div>Language Expert
                                </div>
                            </td>
                        ...
                        <tr
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-blue-500 me-2"></div> Issac Newton
                                </div>
                            </td>
                        ...
                        <tr className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> Tesla
                                </div>
                            </td>
